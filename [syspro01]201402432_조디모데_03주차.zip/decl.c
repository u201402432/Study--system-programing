...
test_rec test_set[] = {
 ...
 {"logicalShift", (funct_t) logicalShift, (funct_t) test_logicalShift,   2, "! ~ & ^ | + << >>", 16, 3, 
 ...
 {"fitsBits", (funct_t) fitsBits, (funct_t) test_fitsBits, 2,"! ~ & ^ | + << >>", 15, 2,
  {{TMin, TMax},{1,32},{TMin,TMax}}},

 {"isPositive", (funct_t) isPositive, (funct_t) test_isPositive, 1,  "! ~ & ^ | + << >>", 8, 3,
  {{TMin, TMax},{TMin,TMax},{TMin,TMax}}},
